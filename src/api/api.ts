...
import { ArrivalData, BusData, RouteData, StationData } from '@/api/types'
...
export const getStationsOnTrip = (tripId: string) => axios.get<StationData>(`route/stations-on-route?trip-id=${tripId}`).then(responseBody)
